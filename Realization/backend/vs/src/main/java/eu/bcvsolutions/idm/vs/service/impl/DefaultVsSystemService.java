...
public class DefaultVsSystemService implements VsSystemService {
     ...
     *
     * @param system       where we will create role
     * @param foundMapping in what mapping
     * @return new role
     */
     ...
     *
     * @param correlationAttribute connecting attribute
     * @param systemMapping        mapping
     * @param systemId             uuid of system
     * @param roleId               uuid of role for system
     ...
     *
     * @param foundMapping created mapping for sync
     ...
     *
     * @param system   in what system
     * @param schemaId for what schema
     * @return sync mapping
     */
